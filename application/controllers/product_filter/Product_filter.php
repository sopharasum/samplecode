<?php
	class Product_filter extends CI_Controller
	{
		...
		{
			parent::__construct();
			$this->load->model('product_filter/product_filter_model');
		}
		...
		public function index()
		{
			...
			$data['storage_data'] = $this->product_filter_model->fetch_filter_type('product_storage');

			$this->load->view('product_filter/product_filter', $data);
		}
