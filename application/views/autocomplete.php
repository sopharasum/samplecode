...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#prefetch .typeahead').typeahead(null, {
			...
			limit:10,
			templates:{
				suggestion:Handlebars.compile('<div class="row"><div class="col-md-2" style="padding-right:5px; padding-left:5px;"><img src="upload/{{image}}" class="img-thumbnail" width="48" /></div><div class="col-md-10" style="padding-right:5px; padding-left:5px;">{{name}}</div></div>')
			}
		});
	});
</script>