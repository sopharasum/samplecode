	...
	<div class="container">
		<div class="row">
			<div class="col-md-8" style="margin:0 auto; float: none;">
				...
				?>
				<form method="POST" enctype="multipart/form-data" action="<?php echo base_url(); ?>sendemail/send">
					<div class="row">
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<select name="programming_languages[]" multiple required class="form-control" style="height: 150px;">
						...
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<input type="text" name="mobile" class="form-control" pattern="\d*" placeholder="Enter Mobile Number" required />
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<textarea name="additional_information" placeholder="Enter Additional Information" rows="8" class="form-control" required></textarea>
							</div>
							<div class="form-group">
